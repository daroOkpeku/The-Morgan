...
<div class="main">
    <!--hero section start-->
    <section class="hero-equal-height pt-165 pb-100" style="background: url('{{asset('/assets/img/bg-shape.svg')}}')no-repeat bottom center / cover; margin-bottom:-200px">
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-md-12 col-lg-6">
                    <div class="img-wrap counter-number d-inline-flex align-items-center mb-4" >
                        <img src="{{asset('/assets/img/landing1.png')}}" alt="hero single" class="custom-width img-fluid">
                    </div>
                </div>
            </div>
        </div>
...
help our clients stay ahead of the rapidly evolving issues. </p>
            ...
            <div class="row justify-content-around">
                <div class="col-md-12 col-lg-6">
                    <div class="about-img-wrap">
                        <img src="{{asset('/assets/img/landing6.jpg')}}" width="400px" alt="video" class="img-fluid rounded shadow-sm color-bip shadow">
     ...
     <section class="about-us-section gray-light-bg ptb-100" style="background: #fff no-repeat center center / cover">>
        <div class="container">
            <div class="row justify-content-around">
                <div class="col-md-12 col-lg-6">
                    <div class="about-img-wrap">
                        <img src="{{asset('/assets/img/landing2.png')}}" alt="video" class="img-fluid rounded shadow-sm">
    ...
    <section class="call-to-action "
             style="background: url('{{asset('/assets/img/cta-bg.svg')}}')no-repeat center center / cover">
        <div class="container">
